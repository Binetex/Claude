      ...
      <CardBody className="space-y-1">
        <div className="mb-1">
          ...
          <p className="text-xs text-slate-500">
            Когда срабатывают ежедневные триггеры («Доставка сегодня») по местному времени
            магазина. Сроки ожидания ответа задаются в самих правилах — поле «Если не ответят на
            это сообщение».
