...
export default async function UsersPage() {
  // Своя проверка, а не только layout раздела: на этой странице список ВСЕХ сотрудников с
  // почтой и ролями, и цена ошибки при переносе страницы выше остальных в разделе.
