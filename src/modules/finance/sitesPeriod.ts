...
export type SitesPeriodKind = "today" | "yesterday" | "week" | "month" | "range";

export type SitesPeriod = {
  kind: SitesPeriodKind;
  from: Date;
  to: Date;
  label: string;
};
...
export const SITES_PERIOD_TABS: { key: SitesPeriodKind; label: string }[] = [
 ...
 */
export function resolveSitesPeriod(
