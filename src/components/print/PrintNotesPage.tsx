...
/**
 * Экран «Печать записок» в кабинете флориста. У владельца печати нет: он печатал бы пачку из
 * заказов разных флористов, а раскладка записки зависит от флориста — в одном документе двух
 * ориентаций листа не бывает.
 */
